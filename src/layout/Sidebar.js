  ...
  return (
    ...
    <nav className=' ml-2 mt-4'>
      <ul className='flex gap-7 w-500 flex-col'>
        <li><a className='flex gap-3  hover:bg-primary-light rounded-full hover:w-32 items-center text-2xl font-light' href=""><HomeIcon/>Home</a></li>
    ...
    <div className=' mb-12 hover:bg-primary-hover rounded-full cursor-pointer items-center flex'>
        <div> 
